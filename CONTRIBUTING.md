# Contributing to ZeroGate Red Teaming

Thank you for your interest in contributing to ZeroGate Red Teaming! We welcome contributions from the community.

## Getting Started

1. **Browse Issues**: Check out our [GitHub Issues](https://github.com/krrishitejas/ZeroGate-Red-Teaming/issues) to find tasks that need work
...
uv run ty check zerogate_red_teaming --exclude zerogate_red_teaming/tests
