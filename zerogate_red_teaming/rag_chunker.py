...
class VectorStore:
    def __init__(self, model_name: str = None):
        ...
        try:
            ...
            print(f"Error initializing HuggingFaceEmbeddings or FAISS: {e}")
            try:
                self.index = faiss.IndexFlatIP(self.dimension)
            except NameError:
                pass
    ...
    def add_chunks(self, chunks: list[dict[str, Any]]):
        try:
            ...
            if vectors_to_add:
                ...
                print(f"Added {len(vectors_to_add)} new chunks to the vector store.")
        except Exception as e:
            print(f"Failed to add chunks: {e}")

    def save(self, index_path: str = None, mapping_path: str = None):
        ...
        try:
            ...
            print(f"Failed to save index/mapping: {e}")


if __name__ == "__main__":
    print("Initializing AST Chunker...")
    chunker = ASTChunker()

    current_file = __file__
    print(f"Parsing and chunking: {current_file}")
