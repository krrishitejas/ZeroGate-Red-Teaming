...
from zerogate_red_teaming.parsers.java.type_inference import JavaTypeInferenceEngine
from zerogate_red_teaming.parsers.js_ts import JsTypeInferenceEngine
from zerogate_red_teaming.parsers.lua.type_inference import LuaTypeInferenceEngine
from zerogate_red_teaming.parsers.py import PythonTypeInferenceEngine
