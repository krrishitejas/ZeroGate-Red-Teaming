...
from zerogate_red_teaming.constants import NODE_UNIQUE_CONSTRAINTS
from zerogate_red_teaming.cypher_queries import (
...
class TestContextManager:
    def test_enter_connects_to_memgraph(self) -> None:
        with patch("zerogate_red_teaming.services.graph_service.mgclient") as mock_mgclient:
            mock_conn = MagicMock()
