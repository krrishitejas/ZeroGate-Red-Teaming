...
from zerogate_red_teaming.main import (
    detect_excludable_directories,
    prompt_for_unignored_directories,
)
from zerogate_red_teaming.utils.path_utils import should_skip_path
...
class TestGetGroupingKey:
    def test_root_level_pattern_returns_itself(self) -> None:
        from zerogate_red_teaming.main import _get_grouping_key
...
class TestGroupPathsByPattern:
    def test_groups_single_level_paths(self) -> None:
        from zerogate_red_teaming.main import _group_paths_by_pattern
    ...
    def test_codebase_with_nested_pycache_groups_correctly(self) -> None:
        ...
        paths = {
            "zerogate_red_teaming/__pycache__",
            "zerogate_red_teaming/tests/__pycache__",
            "zerogate_red_teaming/parsers/__pycache__",
            ".git",
            ".venv",
        }
        groups = _group_paths_by_pattern(paths)
        ...
        assert "zerogate_red_teaming" not in groups
