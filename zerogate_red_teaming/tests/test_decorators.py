...
from zerogate_red_teaming.decorators import (
...
class TestTimingDecorator:
    ...
    def test_logs_timing_info(self) -> None:
        with patch("zerogate_red_teaming.decorators.logger") as mock_logger:
    ...
    def test_handles_exceptions(self) -> None:
        with patch("zerogate_red_teaming.decorators.logger"):
