...
def reset_global_client() -> Generator[None, None, None]:
    import zerogate_red_teaming.vector_store as vs
...
def test_store_embedding_calls_upsert(
    ...
    from zerogate_red_teaming.vector_store import store_embedding
    ...
    with patch(
        "zerogate_red_teaming.vector_store.get_qdrant_client",
...
def test_search_embeddings_calls_query_points(
    ...
    from zerogate_red_teaming.vector_store import search_embeddings
...
def test_store_and_search_roundtrip(integration_client: QdrantClient) -> None:
    from zerogate_red_teaming.vector_store import search_embeddings, store_embedding
