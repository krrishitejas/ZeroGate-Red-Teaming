...
from zerogate_red_teaming.embedder import EmbeddingCache, clear_embedding_cache
from zerogate_red_teaming.utils.dependencies import has_torch, has_transformers
...
def test_embed_code_returns_768_dimensional_vector(
    ...
    with patch("zerogate_red_teaming.embedder.get_model", return_value=mock_unixcoder):
...
def test_embed_code_uses_cache(
    ...
    from zerogate_red_teaming.embedder import embed_code, get_embedding_cache
...
def test_embed_code_batch_empty_list(reset_model_cache: None) -> None:
    from zerogate_red_teaming.embedder import embed_code_batch
...
def test_embed_code_batch_cache_hit(
    ...
    from zerogate_red_teaming.embedder import embed_code_batch, get_embedding_cache
