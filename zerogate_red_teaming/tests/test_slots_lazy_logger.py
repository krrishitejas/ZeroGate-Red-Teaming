...
from zerogate_red_teaming.graph_loader import GraphLoader
...
from zerogate_red_teaming.tools.health_checker import HealthChecker
from zerogate_red_teaming.tools.shell_command import CommandGroup, ShellCommander
...
class TestProviderSlotsInheritance:
    ...
    @patch("zerogate_red_teaming.providers.base.settings")
