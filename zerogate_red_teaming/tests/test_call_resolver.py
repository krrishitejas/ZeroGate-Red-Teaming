...
from zerogate_red_teaming.parsers.call_resolver import CallResolver
from zerogate_red_teaming.parsers.import_processor import ImportProcessor
from zerogate_red_teaming.parsers.type_inference import TypeInferenceEngine
from zerogate_red_teaming.types_defs import NodeType, QualifiedName

if TYPE_CHECKING:
    from zerogate_red_teaming.parsers.call_processor import CallProcessor
...
class TestSeparatorPattern:
    def test_splits_on_dot(self) -> None:
        from zerogate_red_teaming.parsers.call_resolver import _SEPARATOR_PATTERN
...
class TestChainedMethodPattern:
    def test_matches_final_method(self) -> None:
        from zerogate_red_teaming.parsers.call_resolver import _CHAINED_METHOD_PATTERN
