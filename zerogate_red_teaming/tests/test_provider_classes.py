...
from zerogate_red_teaming.constants import GoogleProviderType, Provider
from zerogate_red_teaming.providers.base import (
    GoogleProvider,
    ModelProvider,
    OllamaProvider,
    OpenAIProvider,
...
class TestModelCreation:
    @patch("zerogate_red_teaming.providers.base.PydanticGoogleProvider")
    @patch("zerogate_red_teaming.providers.base.GoogleModel")
    ...
    @patch("zerogate_red_teaming.providers.base.PydanticGoogleProvider")
    @patch("zerogate_red_teaming.providers.base.GoogleModel")
    @patch("zerogate_red_teaming.providers.base.GoogleModelSettings")
    ...
    @patch("zerogate_red_teaming.providers.base.PydanticOpenAIProvider")
    @patch("zerogate_red_teaming.providers.base.OpenAIResponsesModel")
    ...
    @patch("zerogate_red_teaming.providers.base.PydanticOpenAIProvider")
    @patch("zerogate_red_teaming.providers.base.OpenAIChatModel")
