...
from zerogate_red_teaming.language_spec import LANGUAGE_SPECS
...
from zerogate_red_teaming.tests.conftest import create_mock_node

if TYPE_CHECKING:
    from zerogate_red_teaming.types_defs import ASTNode
