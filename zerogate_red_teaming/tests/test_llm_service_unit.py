...
from zerogate_red_teaming.services.llm import (
    CypherGenerator,
...
class TestCypherGenerator:
    @patch("zerogate_red_teaming.services.llm.settings")
    @patch("zerogate_red_teaming.services.llm.get_provider_from_config")
    @patch("zerogate_red_teaming.services.llm.Agent")
...
class TestCreateRagOrchestrator:
    ...
    @patch("zerogate_red_teaming.services.llm.get_provider_from_config")
    @patch("zerogate_red_teaming.services.llm.Agent")
    @patch("zerogate_red_teaming.services.llm.build_rag_orchestrator_prompt")
