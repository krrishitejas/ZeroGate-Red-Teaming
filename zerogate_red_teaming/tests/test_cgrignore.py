...
from zerogate_red_teaming.cli import app
from zerogate_red_teaming.config import (
    CGRIGNORE_FILENAME,
    EMPTY_CGRIGNORE,
    load_cgrignore_patterns,
)
from zerogate_red_teaming.main import prompt_for_unignored_directories
from zerogate_red_teaming.types_defs import CgrignorePatterns
...
class TestCgrignoreIntegration:
    @patch("zerogate_red_teaming.main.Prompt.ask")
    @patch("zerogate_red_teaming.main.app_context")
...
def mock_memgraph_connect() -> Generator[MagicMock, None, None]:
    with patch("zerogate_red_teaming.cli.connect_memgraph") as mock_connect:
...
class TestCgrignoreLoadedWithoutInteractiveSetup:
    ...
    @patch("zerogate_red_teaming.cli.GraphUpdater")
    @patch("zerogate_red_teaming.cli.load_parsers", return_value=({}, {}))
    @patch("zerogate_red_teaming.cli.load_cgrignore_patterns")
    ...
    @patch("zerogate_red_teaming.cli.GraphUpdater")
    @patch("zerogate_red_teaming.cli.load_parsers", return_value=({}, {}))
    @patch("zerogate_red_teaming.cli.ProtobufFileIngestor")
    @patch("zerogate_red_teaming.cli.load_cgrignore_patterns")
    ...
    @patch("zerogate_red_teaming.cli.prompt_for_unignored_directories")
    @patch("zerogate_red_teaming.cli.GraphUpdater")
    @patch("zerogate_red_teaming.cli.load_parsers", return_value=({}, {}))
    @patch("zerogate_red_teaming.cli.load_cgrignore_patterns")
