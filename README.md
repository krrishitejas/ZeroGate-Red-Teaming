<div align="center">
  <picture>
    ...
    <img src="assets/logo-dark-any.png" alt="ZeroGate-Red-Teaming Logo" width="480">
  </picture>

  <p>
  <a href="https://github.com/krrishitejas/ZeroGate-Red-Teaming/stargazers">
    <img src="https://img.shields.io/github/stars/krrishitejas/ZeroGate-Red-Teaming?style=social" alt="GitHub stars" />
  </a>
  <a href="https://github.com/krrishitejas/ZeroGate-Red-Teaming/network/members">
    <img src="https://img.shields.io/github/forks/krrishitejas/ZeroGate-Red-Teaming?style=social" alt="GitHub forks" />
  </a>
  <a href="https://github.com/krrishitejas/ZeroGate-Red-Teaming/blob/main/LICENSE">
    <img src="https://img.shields.io/github/license/krrishitejas/ZeroGate-Red-Teaming" alt="License" />
  </a>
  <a href="https://codecov.io/gh/krrishitejas/ZeroGate-Red-Teaming">
    <img src="https://codecov.io/gh/krrishitejas/ZeroGate-Red-Teaming/graph/badge.svg" alt="Codecov" />
  </a>
  <a href="https://sonarcloud.io/summary/overall?id=krrishitejas_ZeroGate-Red-Teaming">
    <img src="https://sonarcloud.io/api/project_badges/measure?project=krrishitejas_ZeroGate-Red-Teaming&metric=alert_status" alt="Quality Gate Status" />
  </a>
  <a href="https://mseep.ai/app/krrishitejas-ZeroGate-Red-Teaming">
    <img src="https://mseep.net/pr/krrishitejas-ZeroGate-Red-Teaming-badge.png" alt="MseeP.ai Security Assessment" height="20" />
  </a>
  <a href="https://ZeroGate-Red-Teaming.com">
    <img src="https://img.shields.io/badge/Enterprise-Support%20%26%20Services-6366f1" alt="Enterprise Support" />
  </a>
  <a href="https://pepy.tech/projects/ZeroGate-Red-Teaming">
    <img src="https://static.pepy.tech/personalized-badge/ZeroGate-Red-Teaming?period=total&units=INTERNATIONAL_SYSTEM&left_color=BLACK&right_color=GREEN&left_text=downloads" alt="PyPI Downloads" />
  </a>
  <a href="https://scorecard.dev/viewer/?uri=github.com/krrishitejas/ZeroGate-Red-Teaming">
    <img src="https://api.scorecard.dev/projects/github.com/krrishitejas/ZeroGate-Red-Teaming/badge" alt="OpenSSF Scorecard" />
  </a>
</p>
</div>
...
2. **RAG System** (`zerogate_red_teaming/`): Interactive CLI for querying the stored knowledge graph
...
The ZeroGate-Red-Teaming system offers four main modes of operation:
...
```python
from zerogate_red_teaming.graph_loader import load_graph
...
ZeroGate-Red-Teaming makes it easy to add support for any language that has a Tree-sitter grammar. The system automatically handles grammar compilation and integration.
...
> **💡 Request Support**: If you want a specific language to be officially supported, please [submit an issue](https://github.com/krrishitejas/ZeroGate-Red-Teaming/issues) with your language request.
...
5. **Updates Configuration**: Adds the language to `zerogate_red_teaming/language_config.py`
...
📝 Updated zerogate_red_teaming/language_config.py
```
...
The system uses a configuration-driven approach for language support. Each language is defined in `zerogate_red_teaming/language_config.py` with the following structure:
...
[![Star History Chart](https://api.star-history.com/svg?repos=krrishitejas/ZeroGate-Red-Teaming&type=Date)](https://www.star-history.com/#krrishitejas/ZeroGate-Red-Teaming&Date)
