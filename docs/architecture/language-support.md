---
description: "Supported programming languages and their feature coverage in ZeroGate-Red-Teaming."
---

# Language Support

ZeroGate-Red-Teaming uses Tree-sitter for language-agnostic AST parsing with a unified graph schema across all languages.
...
ZeroGate-Red-Teaming makes it easy to add support for any language that has a Tree-sitter grammar. See the [Adding Languages](../advanced/adding-languages.md) guide.

!!! tip
    While you can add languages yourself, we recommend waiting for official full support for optimal parsing quality and comprehensive feature coverage. [Submit a language request](https://github.com/krrishitejas/ZeroGate-Red-Teaming/issues) if you need a specific language supported.
