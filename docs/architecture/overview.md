---
description: "Architecture overview of ZeroGate-Red-Teaming's two-component system for codebase analysis."
---

# Architecture Overview

ZeroGate-Red-Teaming consists of two main components that work together to analyze and query codebases.
...
### 2. RAG System (`zerogate_red_teaming/`)
