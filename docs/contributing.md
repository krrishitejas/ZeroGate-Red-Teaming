---
description: "Contribution guidelines for ZeroGate-Red-Teaming including setup, code standards, and PR process."
---

# Contributing

Thank you for your interest in contributing to ZeroGate-Red-Teaming!

## Getting Started

1. **Browse Issues**: Check out the [GitHub Issues](https://github.com/krrishitejas/ZeroGate-Red-Teaming/issues) to find tasks that need work. Look for `good first issue` and `help wanted` labels.
