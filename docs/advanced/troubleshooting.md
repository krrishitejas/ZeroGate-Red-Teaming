---
description: "Troubleshoot common ZeroGate-Red-Teaming issues with Memgraph, Ollama, and model configuration."
---
...
**Missing node types**: Manually adjust the configuration in `zerogate_red_teaming/language_config.py`.
