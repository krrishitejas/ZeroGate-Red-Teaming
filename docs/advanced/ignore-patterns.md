---
description: "Configure .cgrignore to exclude directories from ZeroGate-Red-Teaming analysis."
---
...
ZeroGate-Red-Teaming automatically excludes common non-source directories such as `.git`, `node_modules`, `__pycache__`, `dist`, `build`, and similar.
