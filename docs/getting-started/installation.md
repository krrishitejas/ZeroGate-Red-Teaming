---
description: "Install ZeroGate-Red-Teaming and set up Memgraph for multi-language codebase analysis."
---
...
```bash
pip install 'ZeroGate-Red-Teaming[treesitter-full]'
```
...
```bash
pip install 'ZeroGate-Red-Teaming[treesitter-full,semantic]'
```
