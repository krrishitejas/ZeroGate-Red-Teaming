---
description: "Query your codebase with natural language using ZeroGate-Red-Teaming's interactive CLI."
---

# Interactive Querying

ZeroGate-Red-Teaming lets you ask questions about your codebase in plain English. The system translates your questions into Cypher queries, executes them against the knowledge graph, and returns relevant results with source code snippets.
