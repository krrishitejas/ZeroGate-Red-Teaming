---
description: "Complete CLI reference for ZeroGate-Red-Teaming commands and Makefile targets."
---

# CLI Reference

The `cgr` command is the main entry point for ZeroGate-Red-Teaming.
