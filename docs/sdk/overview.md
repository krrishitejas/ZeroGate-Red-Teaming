---
description: "Python SDK overview for ZeroGate-Red-Teaming programmatic access."
---

# Python SDK Overview

The `cgr` package provides short imports for programmatic use of ZeroGate-Red-Teaming.
