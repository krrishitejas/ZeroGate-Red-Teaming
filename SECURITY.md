...
Instead, please use [GitHub Private Vulnerability Reporting](https://github.com/krrishitejas/ZeroGate-Red-Teaming/security/advisories/new) to submit your report. This ensures the details remain confidential until a fix is available.
...
This policy applies to the `ZeroGate-Red-Teaming` Python package and its official repository. Third party dependencies are outside the direct scope of this policy, though we use Dependabot to monitor and update them.
